...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '1472a20baf5f80a198c8d5f874c5eb3e',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '零音LyRin-owo', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '「寒冰盈渠结，素霜竟栏凝。」', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://crystal.lyrin-owo.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, blog, 博客, Hazelita, CrystaRin, 镜雨阁, 零音, sc, 雾色深海, 彼方赴尘, 绫音, LyCecilion, SEALchanPS, LyRin-owo', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'LyRin-owo@outlook.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://x.com/LyRin_owo', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/LyRin-owo', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || 'https://t.me/LyRin_owo', // 你的telegram 地址 例如 https://t.me/tangly_1024
  CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || '', // 你的linkedIn 首页
  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || '', // 您的instagram地址
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/182330206', // B站主页
  CONTACT_YOUTUBE: process.env.NEXT_PUBLIC_CONTACT_YOUTUBE || 'https://www.youtube.com/@LyRin-owo', // Youtube主页
  CONTACT_XIAOHONGSHU: process.env.NEXT_PUBLIC_CONTACT_XIAOHONGSHU || 'https://www.xiaohongshu.com/user/profile/65ffa942000000000b00c4f4', // 小红书主页
  ...
  MUSIC_PLAYER_METING_ID:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '6628152665', // 对应歌单的 id
  ...
  COMMENT_WALINE_SERVER_URL: process.env.NEXT_PUBLIC_WALINE_SERVER_URL || 'https://crystarin-waline.lyrin-owo.top', // 请配置完整的Waline评论地址 例如 hhttps://preview-waline.tangly1024.com @see https://waline.js.org/guide/get-started.html
