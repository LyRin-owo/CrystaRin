const CONFIG = {
  ...
  COMMERCE_TEXT_CENTER_TITLE: '镜雨阁文章列表', // 中间产品区块标题
  COMMERCE_TEXT_CENTER_DESCRIPTION:
    '「寒冰盈渠结，素霜竟栏凝。」', // 中间产品区块文字描述
  COMMERCE_TEXT_CENTER_CATEGORY_TITLE: '文章分类', // 左侧产品分类标题
  COMMERCE_TEXT_FOOTER_TITLE: '联系零音', // COMMERCE主题页脚文案标题；按Shift+Enter键可以换行
  COMMERCE_TEXT_FOOTER_MENU_1: '文章分类', // COMMERCE主题页脚左侧菜单标题1
  COMMERCE_TEXT_FOOTER_MENU_2: '探索镜雨阁', // COMMERCE主题页脚左侧菜单标题2
